...
The Layers control button (represented by a stack of three squares) displays a key of the symbols used on the map. It also lets you choose which information you want to see. Click the checkbox for a layer will turn that layer on or off on the map.

The Search feature button (represented by a white box) lets you search for a street address or well name. 
